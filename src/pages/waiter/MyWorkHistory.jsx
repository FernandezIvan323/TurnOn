            ...
            {detail.orders.length === 0 ? (
              ...
              <div className="space-y-3">
                {detail.orders.map((o) => (
                  ...
                  >
                    <div className="flex flex-wrap items-center justify-between gap-2 bg-paper-100 px-3 py-2 text-xs text-ink-600 dark:bg-obsidian-800 dark:text-obsidian-300">
                      <span>
